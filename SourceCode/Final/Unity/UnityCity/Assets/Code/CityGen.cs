...
public class CityGen : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // Place the camera in the center above the city
        Camera.main.transform.position = new Vector3(citySize / 2, terrainHeight * 2, citySize / 2);

        // Hide the loading text
        GameObject.Find("Canvas").GetComponent<CanvasController>().HideLoadingText();
    }
    ...
    void SpawnTerrain()
    {
        ...
        // Spawn water at this height
        GameObject water = Instantiate(prefab_terrainWater, new Vector3(citySize / 2, waterLevel, citySize / 2), Quaternion.identity);

        // Stretch to the size of the city
        water.transform.localScale = new Vector3(citySize / 10, 1, citySize / 10);
    }
